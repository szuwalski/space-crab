...
# data input 
  ...
  # define time priod
    ...
    prob_old_male = c(0,0.05,0.1,0.1,1)#,0.5,0.7,0.9,0.9,0.9,0.9,0.95) 
  ...
  # specify life history parameters
    ...
    F_mean_v =  rnorm(n_t,mean=1,sd=0.5); 
    ...
    n_grpar = 3
    int.male = rep(7.4,n_t); int.female = rep(1,n_t)
    slope.male = rep(1.1,n_t); slope.female = rep(1.5,n_t)
    beta.male = rep(0.75,n_t); beta.female = rep(0.5,n_t)
  ...
  # save results
    ...
    Sim = list('N_at_size_ns_male'=N_at_size_ns_male,'N_at_size_ns_female'=N_at_size_ns_female,
               'C_at_size_ns_male'=C_at_size_ns_male,'C_at_size_ns_female'=C_at_size_ns_female,
               'F_at_size_s'=F_at_size_s,'n_s'=n_s,'n_t'=n_t)
