...
DF = read.csv('/Users/jiecao/Desktop/UW_work/model_devp/SSST/Simulation_Data/shrimp/n200/survey_data.csv')
...
# aggregate catch
catch_raw = read.csv('/Users/jiecao/Desktop/UW_work/model_devp/SSST/Simulation_Data/shrimp/n200/catch_data.csv')
